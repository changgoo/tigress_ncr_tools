...
column-density field `nH`. The regenerated `R8_8pc_NCR_row0000` projections are
included, giving 32 models sampled every 1 Myr from 0 through 600 Myr.
...
- `pdf_delta_area` and `pdf_s_area`, each with shape `(32,601,100)`;
- `std_delta_time` and `std_s_time`, each with shape `(32,601)`;
